...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
{
	...
	{GPIOE, GPIO_PIN_9,   _DEF_INPUT_AF_PP,     GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 2. MOTOR4
	{GPIOE, GPIO_PIN_11,  _DEF_INPUT_AF_PP,     GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 3. MOTOR3
	{GPIOE, GPIO_PIN_13,  _DEF_INPUT_AF_PP,     GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 4. MOTOR2
	{GPIOE, GPIO_PIN_14,  _DEF_INPUT_AF_PP,     GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 5. MOTOR1
